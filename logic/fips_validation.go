...
func ValidatePublicKey(keyB64 string) error {
	if keyB64 == "" {
		...
		return errors.New("invalid base64 encoding: input is empty")
	}
	// 1. Base64 decode
	...
	//lint:ignore SA1019 We are aware this is deprecated and will be replaced by wolfCrypt FIPS API.
...
func GenerateP256KeyPair() (*ecdsa.PrivateKey, string, error) {
	...
	//   → return privRaw (32 bytes) & pubRaw (65 bytes)
	//
